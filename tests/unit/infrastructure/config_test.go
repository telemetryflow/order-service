...
func TestConfig_Load(t *testing.T) {
	...
	t.Run("loads telemetry config from environment", func(t *testing.T) {
		...
		os.Setenv("TELEMETRYFLOW_API_KEY_SECRET", "tfs_env_test")
		os.Setenv("TELEMETRYFLOW_ENDPOINT", "collector.example.com:4317")
		os.Setenv("TELEMETRYFLOW_SERVICE_NAME", "test-service")
